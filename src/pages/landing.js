   ...
   render() {
      return (
        <div>
            ...
            <p className="climateheader2">A single climate accounting system with global consensus.</p>
            <p className="climateheader3">As we move to a stricter management of carbon in our atmospheric commons 
            ...
            <NavLink to='/homepage'><button className="enterButton">ENTER</button></NavLink>
        </div>
      );
   }
}
      ...
      return (
         <div>
            <div className="textDiv">
                ...
                <p className="globaltext">Planet Earth’s atmosphere can hold a limited amount of CO2e emissions 
   ...
   render() {
      ...
      return (
         <div className="explorerDiv">
            ...
            <p className="globalemissiontext">The Emissions & Gaps Explorer shows the aggregate level of global pathways to 
