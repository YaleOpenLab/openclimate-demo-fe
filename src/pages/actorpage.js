...
class ActorPage extends Component {
  ...
  toggleState(index) {
    if (index != this.state.lastIndex && this.state.visibleState == true) {
      this.setState({ visibleState: true });
    } else {
      this.setState({ visibleState: !this.state.visibleState });
    }
    if (this.state.visibleAsset && this.state.visibleState) {
      this.setState({ visibleAsset: false });
      console.log("wtf");
    }
    this.setState({ lastIndex: index });
  }
  toggleAsset(asset, assetInfo) {
    if (asset != this.state.lastAsset && this.state.visibleAsset == true) {
      this.setState({ visibleAsset: true });
    } else {
      this.setState({ visibleAsset: !this.state.visibleAsset });
    }
    ...
    return (
      <div className="actorpage">
          ...
          <div className="colContent">
            ...
            <div className="box1">
              <div className="innerText">
                <span className="large">0.98</span>
                <br />
                <span className="small">
                  <sup>o</sup>C warming relative to 1980
                </span>
                <br />
                <span className="large">411</span>
                <br />
                <span className="small">
                  CO<sub>2</sub> ppm
                </span>
            ...
            <div className="box2">
              ...
              <div className="infoBox">
                <span className="large">550</span>
                <br />
                <span className="small">
                  Gt CO<sub>2</sub>e left based on a 1.5 target
                </span>
                <br />
                <span className="large">50</span>
                <br />
                <span className="small">
                  GtCO<sub>2</sub>e/year
                </span>
                <br />
        ...
        <div className="nationCol">
          ...
          <div className="colContent">
            <div className="box1">
              ...
              <span className="helper">
                <img id="mapUSA" src={mapUSA} alt="mapUSA" />
              </span>
            </div>
            <div className="box1">
              ...
              <div className="pledgeInfo">
                ...
                <div className="small">
                  <span>by 2025 relative to 2005</span>
                </div>
              </div>
            </div>
          ...
          <div className="scroller">
            {this.state.states.map(state => (
              <button
                ...
                onClick={this.toggleState.bind(this, state["Name"])}
              >
        ...
        <StateTab
          ...
          stateVisibility={this.state.visibleState}
          stateName={this.state.lastIndex}
          toggleAsset={this.toggleAsset}
        />
        <div className="assetsCol">
          <div className="colHeader">CLIMATE ACTION ASSETS</div>
        </div>
        <AssetTab
          asset={this.state.assetInfo}
          assetVisibility={this.state.visibleAsset}
          assetName={this.state.lastAsset}
        />
        <Footer />
      </div>
    );
...
class AssetTab extends Component {
  ...
  render() {
    ...
    var visibility = "hidden";
    if (this.props.assetVisibility) {
      visibility = "show";
    }
    if (this.props.assetVisibility == false) {
      visibility = "hide";
    }
    return (
          ...
          <div>
            ...
            <div className="assetInfo">
              ...
              {this.props.asset["ActionType"] && (
                <div>
                  {this.props.asset["ActionType"].map(type => (
                    <div className="actionBubble">{type}</div>
                  ))}
                </div>
              )}
              ...
              <div className="boxes">
                <div className="dataBox" id="1">
                  <span className="size1">{this.props.asset["Capacity"]}</span>{" "}
                  <br />
                  <span className="size2"> MW </span>
                  <br />
                  ...
                  <>
                    <div className="dataBox" id="2">
                      <span className="size1">
                        {" "}
                        {this.props.asset["Reports"][0]["MitigationOutcomes"]}
                      </span>{" "}
                      <br />
                      <span className="size2">
                        {" "}
                        {this.props.asset["Reports"][0]["Year"]}
                      </span>{" "}
                      <br />
                    ...
                    <div className="dataBox" id="3">
                      <span className="size1">
                        {" "}
                        {this.props.asset["Reports"][0]["GWh"]}
                      </span>{" "}
                      <br />
