...
const web3 = new Web3(new Web3.providers.HttpProvider("https:/kovan.infura.io/v3/def7370cf49d49d791b9df949986b9a0"));
...
class Insights extends Component{
	...
	*/
    async readRoot() {
        console.log(web3);
        const rootContract = new web3.eth.Contract(abi, "0x1d0a334994a361111a193b98e6548bf0e8395879");
        let timeStamp = web3.utils.toHex(this.state.timeStamp);
        await rootContract.methods.getRoot(timeStamp).call()
            .then((result) => {
                console.log(result);
	...
	render(){
		return(
            <div className="textBox">
                ...
                >
                    <DialogTitle id="dialog-title">{"IPFS root hash retrieved from the smart contract:"}</DialogTitle>
                    <DialogContent>
                        <Paper>
