  ...
  render() {
    return (
      <div className="homepage">
        ...
        <SideMenu
          toggleGlobe={this.toggleGlobe}
          toggleTool={this.toggleTool}
          toggleInsights={this.toggleInsights}
          toggleLearn={this.toggleLearn}
          activeGlobe={this.state.activeGlobe}
          activeTool={this.state.activeTool}
          activeInsights={this.state.activeInsights}
          activeLearn={this.state.activeLearn}
        />
    ...
    return (
      <div className="sideMenu">
        <div className="buttons">
          <button
            id="sideButton"
            className={this.props.activeGlobe}
            onClick={this.props.toggleGlobe}
          >
          ...
          <button
            ...
            onClick={this.props.toggleTool}
          >
            <img src={viewImage} id="buttonImg" />
          </button>
          <button
            id="sideButton"
            className={this.props.activeInsights}
            onClick={this.props.toggleInsights}
          >
            <img src={insightsImage} id="buttonImg" />
          </button>
          <button
            id="sideButton"
            className={this.props.activeLearn}
            onClick={this.props.toggleLearn}
          >
